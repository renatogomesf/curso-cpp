...
int main()
{
    ...
    // fstream "File Stream -> FSstream": pode ser definido como entrada e saida.
    ...
    // "ios::app": sem ele o aquivo gerado tem seu conteúdo sobrescrito sempre que for adicionado algo. usando "ios::app" o conteúdo não é sobrescrito... o cursor vai pro final do conteúdo ja existen no arquivo e adiciona o novo.
